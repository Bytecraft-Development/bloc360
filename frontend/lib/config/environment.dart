class EnvironmentConfig {
  ...
  static const GOOGLE_LOGIN_URL = '${KEYCLOAK_BASE_URL}/protocol/openid-connect/auth?client_id=bloc360google&redirect_uri=https://bloc360.live/dashboard&response_type=code&scope=openid&kc_idp_hint=google';
