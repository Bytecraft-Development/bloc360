...
//                Integer numOfHouseHolds = expense.getExpenseHouseholds().size();
//                expensePerHouseHold = expense.getAmount().divide(BigDecimal.valueOf(numOfHouseHolds), 3, RoundingMode.HALF_EVEN);
//                for (ExpenseHouseholds houseHold : expense.getExpenseHouseholds()) {
//                    Payment payment = new Payment();
//                    payment.setExpense(expense);
//                    payment.setHouseHold(houseHold.getHouseHold());
